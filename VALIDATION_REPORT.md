...
| Semantic local preview | Passed | [Sanitized semantic preview](artifacts/sanitized-preview-semantic.png) shows category-only placeholders, preserved public labels and checkbox state, WASM local inference, and no reasoning request. It represents the strict/default visual mode. |
